				...
				<div style={{ display: "flex", flexDirection: "column", rowGap: "5px" }}>
					...
					<Pane
						...
						<div
							...
							<p
								...
								Be careful for the model capabilities, as they can affect how Seen-18 can work.
							</p>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Seen-18 uses complex prompts and works best
...
export function getGlamaAuthUrl(uriScheme?: string) {
	const callbackUrl = `${uriScheme || "vscode"}://code-quests.seen18/glama`

	return `https://glama.ai/oauth/authorize?callback_url=${encodeURIComponent(callbackUrl)}`
}

export function getOpenRouterAuthUrl(uriScheme?: string) {
	return `https://openrouter.ai/auth?callback_url=${uriScheme || "vscode"}://code-quests.seen18/openrouter`
}
